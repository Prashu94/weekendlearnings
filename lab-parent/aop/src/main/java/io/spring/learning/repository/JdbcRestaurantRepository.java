...
public class JdbcRestaurantRepository implements RestaurantRepository{
    ...
    void populateRestaurantCache() {
        ...
        String sql = "select MERCHANT_NUMBER, NAME, BENEFIT_PERCENTAGE, BENEFIT_AVAILABILITY_POLICY from " +
                "T_RESTAURANT";
    ...
    private Restaurant mapRestaurant(ResultSet rs) throws SQLException {
        ...
        String benefitAvailabilityPolicy = rs.getString("BENEFIT_AVAILABILITY_POLICY");
        // map to the object
        Restaurant restaurant = new Restaurant(number, name);
        restaurant.setBenefitPercentage(benefitPercentage);
        restaurant.setDbBenefitAvailabilityPolicy(benefitAvailabilityPolicy);
        return restaurant;
    }
}
