...
public abstract class AbstractAccountManagerTests {
    ...
    public void updateAccount() {
        Account oldAccount = accountManager.getAccount(1L);
        oldAccount.setName("Ben Hale");
        accountManager.update(oldAccount);
        Account newAccount = accountManager.getAccount(1L);
    ...
    public void updateAccountBeneficiaries() {
        ...
        accountManager.updateBeneficaryAllocationPercentages(1L, allocationPercentages);
        Account account = accountManager.getAccount(1L);
    ...
    public void addBeneficiary() {
        accountManager.addBeneficiary(1L, "Ben");
        Account account = accountManager.getAccount(1L);
    ...
    public void removeBeneficiary() {
        ...
        accountManager.removeBeneficiary(1L, "Annabelle", allocationPercentages);
        Account account = accountManager.getAccount(1L);
